% FLMguide.tex -- the official Journal of Fluid Mechanics author guide (Cambridge,
% 2025), adapted by M.-J. Thoraval to demonstrate the enhanced bibliography style.
% Changes from the official guide:
%  - \usepackage{patches} (loads jabbrv + the DOI/year hyperlink setup);
%  - the reference list is generated from jfm.bib via jfm_jabbrv.bst and pasted
%    inline (between the BEGIN/END-INLINE-BBL markers), replacing the hand-written
%    thebibliography; a \bibliography{jfm} variant is documented alongside it;
%  - added a citation for Edwards et al. (2017) plus a note, so the guide obeys the
%    JFM rule that every listed reference is cited -- Abramowitz & Barker are left
%    uncited to show that uncited entries do not appear;
%  - minor corrections to the example references (see jfm.bib).
% The body of the document is otherwise Cambridge's, unchanged.
%
%\documentclass[lineno]{jfm}
\documentclass[lineno]{JFM-FLM_Au}
\usepackage{patches} % jabbrv (journal abbreviation) + DOI/year hyperlinks; required by the generated bibliography
...
\bibitem[Batchelor (1959)]{Batchelor59}
{\sc Batchelor, G.K.} 1959 {Small-scale variation of convected
...
{\sc Brownell,  C.J.  and Su,  L.K.} 2004  {Planar measurement
...
% ============================ Bibliography ============================
% Generated from jfm.bib with the enhanced style jfm_jabbrv.bst.  It can
% be produced two equivalent ways -- test_bibliography.py checks that they
% give identical output:
%   (A) BibTeX:  pdflatex -> bibtex -> pdflatex -> pdflatex, using
%         \bibliographystyle{jfm_jabbrv}
%         \bibliography{jfm}
%   (B) Inline:  the generated .bbl pasted below (what you submit).
% Keep the inline block in sync with jfm.bib -- the test enforces it.
% =====================================================================
%\bibliographystyle{jfm_jabbrv}
%\bibliography{jfm}
%%%BEGIN-INLINE-BBL%%%
...
\bibitem[Batchelor(1959)]{Batchelor59}
{\sc \au{Batchelor, G.}} \yr{1959}  \at{Small-scale variation of convected
  quantities like temperature in turbulent fluid {P}art 1. {G}eneral discussion
  and the case of small conductivity.}  \jt{{\JournalTitle{J. Fluid Mech.}}}
  \href{https://doi.org/10.1017/S002211205900009X}{ \bvol{5},  \pg{113--133}}.

\bibitem[Bouguet(2008)]{Bouguet01}
{\sc \au{Bouguet, J.-Y.}} \yr{2008} Camera calibration toolbox for matlab.
  \url{http://www.vision.caltech.edu/bouguetj/calib_doc/}.

\bibitem[Briukhanov {\em et~al.\/}(1967)Briukhanov, Grigorian, Miagkov, Plam,
  Shurova, Eglit \& Yakimov]{Briukhanovetal1967}
{\sc \au{Briukhanov, A.~V.}, \au{Grigorian, S.~S.}, \au{Miagkov, S.~M.},
  \au{Plam, M.~Y.}, \au{Shurova, I.~E.}, \au{Eglit, M.~E.} \& \au{Yakimov,
  Y.~L.}} \yr{1967} On some new approaches to the dynamics of snow avalanches.
  \bt{In {\em Physics of Snow and Ice, Proceedings of the International
  Conference on Low Temperature Science\/}},  \vol{vol.~1},
  \href{https://hdl.handle.net/2115/20373}{ \pg{1223--1241}}.  \publ{Institute
  of Low Temperature Science, Hokkaido University, Sapporo, Hokkaido, Japan}.

\bibitem[Brownell \& Su(2004)]{Brownell04}
{\sc \au{Brownell, C.} \& \au{Su, L.}} \yr{2004}  \at{Planar measurement of
  differential diffusion in turbulent jets}.
  \jt{\href{https://doi.org/10.2514/6.2004-2335}{{\JournalTitle{AIAA Paper
  2004-2335}}}}.

\bibitem[Brownell \& Su(2007)]{Brownell07}
{\sc \au{Brownell, C.} \& \au{Su, L.}} \yr{2007}  \at{Scale relations and
  spatial spectra in a differentially diffusing jet}.
  \jt{\href{https://doi.org/10.2514/6.2007-1317}{{\JournalTitle{AIAA Paper
  2007-1317}}}}.

\bibitem[Dennis(1985)]{Dennis85}
{\sc \au{Dennis, S.}} \yr{1985}  \at{{Compact explicit finite difference
  approximations to the Navier--Stokes equation}}.  \bt{In {\em Ninth Intl
  Conf. on Numerical Methods in Fluid Dynamics\/} (ed. \ed{Soubbaramayer \&
  J.~Boujot})},  \st{Lecture Notes in Physics},  \vol{vol. 218},
  \href{https://doi.org/10.1007/3-540-13917-6_107}{ \pg{23--51}}.
  \publ{Springer}.

\bibitem[Edwards {\em et~al.\/}(2017)Edwards, Viroulet, Kokelaar \&
  Gray]{EdwardsVirouletKokelaarGray2017}
{\sc \au{Edwards, A.~N.}, \au{Viroulet, S.}, \au{Kokelaar, B.~P.} \& \au{Gray,
  J. M. N.~T.}} \yr{2017}  \at{Formation of levees, troughs and elevated
  channels by avalanches on erodible slopes}.  \jt{{\JournalTitle{J. Fluid
  Mech.}}} \href{https://doi.org/10.1017/jfm.2017.309}{ \bvol{823},
  \pg{278--315}}.

\bibitem[Hwang \& Tuck(1970)]{Hwang70}
{\sc \au{Hwang, L.-S.} \& \au{Tuck, E.}} \yr{1970}  \at{On the oscillations of
  harbours of arbitrary shape}.  \jt{{\JournalTitle{J. Fluid Mech.}}}
  \href{https://doi.org/10.1017/S0022112070001404}{ \bvol{42},  \pg{447--464}}.

\bibitem[Joseph \& Saut(1990)]{JosephSaut1990}
{\sc \au{Joseph, D.~D.} \& \au{Saut, J.~C.}} \yr{1990}  \at{Short-wave
  instabilities and ill-posed initial-value problems}.
  \jt{{\JournalTitle{Theoretical and Computational Fluid Dynamics}}}
  \href{https://doi.org/10.1007/BF00418002}{ \bvol{1},  \pg{191--227}}.

\bibitem[Koch(1983)]{Koch83}
{\sc \au{Koch, W.}} \yr{1983}  \at{Resonant acoustic frequencies of flat plate
  cascades}.  \jt{{\JournalTitle{J. Sound Vib.}}}
  \href{https://doi.org/10.1016/0022-460X(83)90639-9}{ \bvol{88},
  \pg{233--242}}.

\bibitem[Lee(1971)]{Lee71}
{\sc \au{Lee, J.-J.}} \yr{1971}  \at{Wave-induced oscillations in harbours of
  arbitrary geometry}.  \jt{{\JournalTitle{J. Fluid Mech.}}}
  \href{https://doi.org/10.1017/S0022112071000090}{ \bvol{45},  \pg{375--394}}.

\bibitem[Linton \& Evans(1992)]{Linton92}
{\sc \au{Linton, C.} \& \au{Evans, D.}} \yr{1992}  \at{The radiation and
  scattering of surface waves by a vertical circular cylinder in a channel}.
  \jt{{\JournalTitle{Phil. Trans. R. Soc. Lond.}}}
  \href{https://doi.org/10.1098/rsta.1992.0011}{ \bvol{338},  \pg{325--357}}.

\bibitem[Martin(1980)]{Martin80}
{\sc \au{Martin, P.}} \yr{1980}  \at{On the null-field equations for the
  exterior problems of acoustics}.  \jt{{\JournalTitle{Q. J. Mech. Appl.
  Maths}}} \href{https://doi.org/10.1093/qjmam/33.4.385}{ \bvol{33},
  \pg{385--396}}.

\bibitem[Miller(1991)]{Miller91}
{\sc \au{Miller, P.}} \yr{1991}  \at{Mixing in high schmidt number turbulent
  jets}. \href{https://doi.org/10.7907/PN2P-RK49}{PhD thesis}, California
  Institute of Technology.

\bibitem[Rogallo(1981)]{Rogallo81}
{\sc \au{Rogallo, R.}} \yr{1981}  \bt{Numerical experiments in homogeneous
  turbulence}. \href{https://ntrs.nasa.gov/citations/19810022965}{{\em Tech.
  Rep.\/} 81835}.  \org{NASA Tech.\ Mem.}

\bibitem[Ursell(1950)]{Ursell50}
{\sc \au{Ursell, F.}} \yr{1950}  \at{Surface waves on deep water in the
  presence of a submerged circular cylinder. {I}}.  \jt{{\JournalTitle{Proc.
  Camb. Phil. Soc.}}} \href{https://doi.org/10.1017/S0305004100025561}{
  \bvol{46},  \pg{141--152}}.

\bibitem[{van Wijngaarden}(1968)]{Wijngaarden68}
{\sc \au{{van Wijngaarden}, L.}} \yr{1968}  \at{On the oscillations near and at
  resonance in open pipes}.  \jt{{\JournalTitle{J. Engng Maths}}}
  \href{https://doi.org/10.1007/BF01535773}{ \bvol{2},  \pg{225--240}}.

\bibitem[Worster(1992)]{Worster92}
{\sc \au{Worster, M.}} \yr{1992}  \at{{The dynamics of mushy layers}}.  \bt{In
  {\em Interactive dynamics of convection and solidification\/} (ed.
  \ed{S.~Davis, H.~Huppert, W.~Muller \& M.~Worster})},
  \href{https://doi.org/10.1007/978-94-011-2809-4_20}{ \pg{113--138}}.
  \publ{Kluwer}.
